...
/**
 * Handles the error code RESULT_NO_MAX_DISTANCE
 */
public class HandleProblemStartNoMaxDistance implements HandleProblemStartInterface
{
	...
	public void handle(Context context)
	{
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(context)
				...
				.setMessage(context.getString(R.string.error_no_max_distance_saved))
				.setPositiveButton(context.getString(R.string.error_button_positive), new OnClickListener()
				{
					...
					public void onClick(DialogInterface dialog, int which)
					{
						...
						mainActivity.handleMaxDistance(null);
					}
				})
