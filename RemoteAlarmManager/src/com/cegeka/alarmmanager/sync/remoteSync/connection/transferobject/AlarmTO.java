package com.cegeka.alarmmanager.sync.remoteSync.connection.transferobject;
...
public class AlarmTO {
    ...
    public AlarmTO(int id,  String title,String info, boolean repeated, String repeat_unit, long date, int repeatQuantity, long repeatEndDate) {
        setDate(date);
        setId(id);
        setTitle(title);
        setInfo(info);
